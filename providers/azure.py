...
def create_network(name=None, region=REGION, public_cidr=PUBLIC_CIDR, private_cidr=PRIVATE_CIDR,
                  bastion_zone=ZONE, bastion_machine_image=OS,
                  bastion_machine_type=BASTION_MACHINE_TYPE, resource_group=None,
                  subscription_id=None, tenant_id=None, application_id=None,
                  client_certificate_path=None, vpc_cidr=None, expose_ui=False, rack_aware=False,
...
def create_bastion(name, zone, machine_type, machine_image, region, resource_group):
    """
